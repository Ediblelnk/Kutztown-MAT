...
\begin{enumerate}
    ...
    \qitem{33}{$n\mathcal{R}m \tin \bb{Z}^+ \tif n \tand m$ have the same number of digits in the usual base ten notation}{
        ...
        \end{enumerate}
        The partition resulting from this equivalence relation will be classes where each member has the same number of digits, i.e. all single digit numbers will be in a class, all 2 digit numbers will be in a class, all three digit numbers will be in a class, etc.
    }
\end{enumerate}
